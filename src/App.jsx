...
const initialState = {
  ...
  const onClickHandle = (event)=>{
    ...
    const form = username.current
    alert(`${form['username'].value} ${form['lastname'].value}`)
  }
        ...
        <div class="sm:col-span-4">
          ...
          <div class="mt-2">
            ...
            <div class="mt-6 flex items-center justify-end gap-x-6">
              <button type="button" class="text-sm/6 font-semibold text-gray-900" onClick={onClickReset} >Reset</button>
